...
class ChuanglanSms{
    ...
    //const API_ACCOUNT='VIP-wmqt0_mfzs';//创蓝账号 替换成你自己的账号
    const API_ACCOUNT='VIP-wmqt0_zhtc';//创蓝账号 替换成你自己的账号
    //const API_PASSWORD='W6281207c';//创蓝密码 替换成你自己的密码
    const API_PASSWORD='Zhtc123456';//创蓝密码 替换成你自己的密码
